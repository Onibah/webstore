(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        da.init();
        const CategoryLinkAll = document.querySelector(".category-item-filter-products__link-all");
        const CategoryLinks = document.querySelectorAll(".category-item-filter-products__link");
        if (CategoryLinkAll || CategoryLinks) CategoryLinks.forEach((CategoryLink => {
            document.addEventListener("click", (function(e) {
                const targetElement = e.target;
                if (targetElement.closest(".category-item-filter-products__link")) {
                    targetElement.closest(".category-item-filter-products__link").classList.toggle("_item-active");
                    CategoryLinkAll.classList.remove("_item-active");
                    e.preventDefault();
                }
                if (targetElement.closest(".category-item-filter-products__link-all")) {
                    targetElement.closest(".category-item-filter-products__link-all").classList.add("_item-active");
                    CategoryLink.classList.remove("_item-active");
                    e.preventDefault();
                }
            }));
        }));
        const clear = document.querySelector(".clear-size");
        const sizeLinks = document.querySelectorAll(".size-item-filter-products__link");
        sizeLinks.forEach((sizeLink => {
            sizeLink.addEventListener("click", (function(e) {
                sizeLink.classList.toggle("_size-link-active");
                e.preventDefault();
            }));
            clear.addEventListener("click", (function(e) {
                sizeLink.classList.remove("_size-link-active");
            }));
        }));
        const clearColor = document.querySelector(".clear-color");
        const colorLinks = document.querySelectorAll(".color-item-filter-products__link");
        colorLinks.forEach((colorLink => {
            colorLink.addEventListener("click", (function(e) {
                colorLink.classList.toggle("_active-color");
                e.preventDefault();
            }));
            clearColor.addEventListener("click", (function(e) {
                colorLink.classList.remove("_active-color");
            }));
        }));
        const clearPrice = document.querySelector(".clear-price");
        const priceLinks = document.querySelectorAll(".price-item-filter-products__link");
        priceLinks.forEach((priceLink => {
            priceLink.addEventListener("click", (function(e) {
                priceLink.classList.toggle("_active-price");
                e.preventDefault();
            }));
            clearPrice.addEventListener("click", (function(e) {
                priceLink.classList.remove("_active-price");
            }));
        }));
        window["FLS"] = true;
        isWebp();
